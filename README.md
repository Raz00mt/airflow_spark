...
4) Подключить контейнеры спарка к сети аирфлоу (docker inspect {airflow_spark_default} затем docker network connect {airflow_spark_default} spark-master/spark-worker)
